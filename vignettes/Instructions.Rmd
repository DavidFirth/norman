...
# 0.5. Add the **norman** and **rmarkdown** packages to your _R_ installation 
...
devtools::install_github("DavidFirth/norman", build_opts = "")
```

The installation of **norman** should also trigger the installation of 3 other 
packages if you do not have them already.  They are **aplpack**, **knitr** 
and **ggplot2**.

## 0.5.2 Installing **rmarkdown**
...
(This will be needed whenever the **norman** package itself has been 
...
you should skip this section for now but keep it in mind for later.)

To update **norman** to the _latest version_ of the package: in your _R_ console, 
issue the following command:
```
devtools::install_github("DavidFirth/norman", build_opts = "")
```
If you see a _warning_ message after doing that, it can be safely ignored.
