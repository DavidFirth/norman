...
### A normal Q-Q plot of the module effects
...
Points near the ends of the graph that are far above or far below the line represent modules that deserve scrituny.
...
thegraph <- qqplot.data(mdf$Effect)
thegraph <- thegraph + labs(x = "Normal quantile", y = "Module effect")
thegraph
```
